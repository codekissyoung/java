...
public class HelloWorld {
    ...
    public static void main(String[] args) {
        ...
        com.codekissyoung.Employee link = new com.codekissyoung.Employee("link");
        com.codekissyoung.Employee max = new com.codekissyoung.Employee("max",700);
        ...
        com.codekissyoung.Employee[] emps = new com.codekissyoung.Employee[2];
        emps[0] = link;
        emps[1] = max;

        for(com.codekissyoung.Employee e : emps){
            e.printEmployee();
        }
